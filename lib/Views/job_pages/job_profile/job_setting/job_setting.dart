...
import 'package:job_seeker/Views/job_pages/job_authentication/job_login.dart';
              ...
              InkWell(
                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      children: [
                        Image.asset(JobPngimage.profilecomplate,height: height/12),
...
/*              SizedBox(height: height/80,),
              InkWell(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width: width/26),
                    Text("Job_Seeking_Status".tr,style: urbanistSemiBold.copyWith(fontSize: 18)),
                    const Spacer(),
              ...
              InkWell(
                ...
                child: Row(
                  children: [
                    Image.asset(JobPngimage.profiles,height: height/30,width: height/30,color: themedata.isdark ? JobColor.white : JobColor.black,),
                    SizedBox(width: width/26),
                    Text("Personal_Information".tr,style: urbanistSemiBold.copyWith(fontSize: 18)),
                    const Spacer(),
                    const Icon(Icons.arrow_forward_ios_outlined,size: 15),
                  ],
                ),
              ...
              InkWell(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width: width/26),
                    Text("Linked_Accounts".tr,style: urbanistSemiBold.copyWith(fontSize: 18)),
                    const Spacer(),
                    const Icon(Icons.arrow_forward_ios_outlined,size: 15),
                  ],
                ),
              ...
              SizedBox(height: height/56,),
               Divider(color: themedata.isdark?JobColor.borderblack:JobColor.bggray),
              SizedBox(height: height/56,),
              Text("General".tr,style: urbanistSemiBold.copyWith(fontSize: 16,color: JobColor.textgray)),
              SizedBox(height: height/36,),
              InkWell(
                splashColor: JobColor.transparent,
                highlightColor: JobColor.transparent,
                ...
                child: Row(
                  children: [
                    Image.asset(JobPngimage.notification,height: height/30,width: height/30,color: themedata.isdark ? JobColor.white : JobColor.black,),
                    SizedBox(width: width/26),
...
/*              SizedBox(height: height/36,),
              InkWell(
                ...
                child: Row(
                  children: [
                    Image.asset(JobPngimage.work2,height: height/30,width: height/30,color: themedata.isdark ? JobColor.white : JobColor.black,),
                    SizedBox(width: width/26),
                    Text("Application_Issues".tr,style: urbanistSemiBold.copyWith(fontSize: 18)),
                    const Spacer(),
                    const Icon(Icons.arrow_forward_ios_outlined,size: 15),
                  ],
                ),
              ...
              InkWell(
                ...
                child: Row(
                  children: [
                    Image.asset(JobPngimage.timesquare,height: height/30,width: height/30,color: themedata.isdark ? JobColor.white : JobColor.black,),
                    SizedBox(width: width/26),
                    Text("Timezone".tr,style: urbanistSemiBold.copyWith(fontSize: 18)),
                    const Spacer(),
                    const Icon(Icons.arrow_forward_ios_outlined,size: 15),
                  ],
                ),
              ...
              InkWell(
                ...
                child: Row(
                  children: [
                    Image.asset(JobPngimage.morecircle,height: height/30,width: height/30,color: themedata.isdark ? JobColor.white : JobColor.black,),
                    SizedBox(width: width/26),
              ...
              InkWell(
                ...
                child: Row(
                  children: [
                    Image.asset(JobPngimage.usericon3,height: height/30,width: height/30,color: themedata.isdark ? JobColor.white : JobColor.black,),
                    SizedBox(width: width/26),
              ...
              InkWell(
                ...
                child: Row(
                  children: [
                    Image.asset(JobPngimage.lock,height: height/30,width: height/30,color:JobColor.red,),
                    SizedBox(width: width/26),
                    Text("Deactivate_MyAccount".tr,style: urbanistSemiBold.copyWith(fontSize: 18,color: JobColor.red)),
                    const Spacer(),
                    const Icon(Icons.arrow_forward_ios_outlined,size: 15),
                  ],
                ),
