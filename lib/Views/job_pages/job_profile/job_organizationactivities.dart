...
class JobOrganizationActivities extends StatefulWidget {
  const JobOrganizationActivities({Key? key}) : super(key: key);

  @override
  State<JobOrganizationActivities> createState() => _JobOrganizationActivitiesState();
}

class _JobOrganizationActivitiesState extends State<JobOrganizationActivities> {
  dynamic size;
  double height = 0.00;
  double width = 0.00;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("Organization_Activities".tr,style: urbanistBold.copyWith(fontSize: 22 )),
        actions: [
          Padding(
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Text("Still a member".tr,style: urbanistMedium.copyWith(fontSize: 16 )),
                ],
              ),
              SizedBox(height: height/46,),
