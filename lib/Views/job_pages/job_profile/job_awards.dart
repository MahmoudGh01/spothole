...
class JobAwards extends StatefulWidget {
  const JobAwards({Key? key}) : super(key: key);

  @override
  State<JobAwards> createState() => _JobAwardsState();
}

class _JobAwardsState extends State<JobAwards> {
  dynamic size;
  double height = 0.00;
  double width = 0.00;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("Awards_Achievements".tr,style: urbanistBold.copyWith(fontSize: 22 )),
        actions: [
          Padding(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text("Issuer".tr,style: urbanistMedium.copyWith(fontSize: 16 )),
              SizedBox(height: height/66,),
              TextField(
                style: urbanistSemiBold.copyWith(fontSize: 16),
                decoration: InputDecoration(
              ...
              SizedBox(height: height/46,),
              Text("Date_Awarded".tr,style: urbanistMedium.copyWith(fontSize: 16 )),
              SizedBox(height: height/66,),
              TextField(
                style: urbanistSemiBold.copyWith(fontSize: 16),
                decoration: InputDecoration(
                  hintStyle: urbanistRegular.copyWith(fontSize: 16,color:JobColor.textgray,),
                  hintText: "Date_Awarded".tr,
                  fillColor: themedata.isdark?JobColor.lightblack:JobColor.appgray,
